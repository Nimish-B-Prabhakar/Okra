...
export function AudioPlayer({ duration, onComplete, onProgress }: AudioPlayerProps) {
  ...
  const bars = Array.from({ length: 28 }, (_, i) => {
    const heights = [40, 55, 35, 70, 50, 80, 45, 60, 75, 40, 65, 50, 85, 45,
                     70, 55, 40, 75, 50, 65, 35, 80, 60, 45, 70, 55, 40, 65]
          ...
          <div
            ...
            style={{
              ...
              background: i < filledBars
                ? (completed ? 'var(--success)' : 'var(--accent)')
                : 'var(--border)',
              transition: playing ? 'background 0.1s ease' : 'none',
              animation: playing && Math.abs(i - filledBars) < 3
